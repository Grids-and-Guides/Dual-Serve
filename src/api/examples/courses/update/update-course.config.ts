...
import { updateCourseSchema } from './update-course.dto';
...
export const updateCourseFunction = new FunctionConfig({
    ...
    srcFile: path.resolve(process.cwd(),"src/api/examples/courses/update/update-course.ts"),
    output: path.resolve(process.cwd(), "dist/src/api/examples/courses/update/index.js"),
    memory:256,
    concurrency: 10,
    timeout:30,
    environmentVariable: {
