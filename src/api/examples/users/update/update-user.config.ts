...
export const updateUserFunction = new FunctionConfig({
    ...
    srcFile: path.resolve(process.cwd(),"src/api/examples/users/update/update-user.ts"),
    output: path.resolve(process.cwd(), "dist/src/api/examples/users/update/index.js"),
    memory:256,
    concurrency: 10,
    timeout:30,
    environmentVariable: {
